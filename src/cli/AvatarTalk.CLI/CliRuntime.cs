...
internal static class CliRuntime
{
    ...
    public static async Task<global::AvatarTalk.AvatarTalkClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::AvatarTalk.ApiException exception)
    {
        var builder = new StringBuilder();
