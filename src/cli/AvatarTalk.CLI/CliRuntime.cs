...
namespace AvatarTalk.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "AvatarTalk.CLI";
    private const string UserSecretApiKeyName = "AVATARTALK_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"AVATARTALK_API_KEY"];
    private const string CredentialFileDirectoryName = ".avatar-talk";

    public static async global::System.Threading.Tasks.Task<global::AvatarTalk.AvatarTalkClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::AvatarTalk.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::AvatarTalk.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::AvatarTalk.AvatarTalkClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::AvatarTalk.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::AvatarTalk.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::AvatarTalk.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::AvatarTalk.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("AVATARTALK_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::AvatarTalk.ApiException exception)
    {
        var builder = new StringBuilder();
