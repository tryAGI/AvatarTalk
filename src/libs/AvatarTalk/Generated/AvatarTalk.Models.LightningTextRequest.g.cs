...
{
    /// <summary>
    /// Request body for Lightning Network text-based video generation
    /// </summary>
    public sealed partial class LightningTextRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LightningTextRequest" /> class.
        /// </summary>
        /// <param name="text">
        /// The text for the avatar to speak
        /// </param>
